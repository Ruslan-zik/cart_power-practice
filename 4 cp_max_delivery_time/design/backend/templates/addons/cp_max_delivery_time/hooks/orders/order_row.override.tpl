{if $o.cp_max_delivery_time > $smarty.now && !$addons.cp_max_delivery_time.order_status.{$o.status}}
<tr class="cp_delivery_time">
{else}
<tr>
{/if}
    <td class="left">
    ...
    {* <p>{$o.cp_max_delivery_time|date_format:"`$settings.Appearance.date_format`, `$settings.Appearance.time_format`"}</p> *}
    <td>
