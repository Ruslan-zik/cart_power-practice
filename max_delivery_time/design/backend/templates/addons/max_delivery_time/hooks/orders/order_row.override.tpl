{if $o.max_delivery_time > $smarty.now && !$addons.max_delivery_time.order_status.{$o.status}}
...
{/if}
    ...
    {* <p>{$o.max_delivery_time|date_format:"`$settings.Appearance.date_format`, `$settings.Appearance.time_format`"}</p> *}
    <td>
