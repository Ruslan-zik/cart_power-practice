...
namespace Tygh\Addons\delivery_date\Template\Snippet\Table;
 ...
 *
 * @package Tygh\Addons\delivery_date\Template\Snippet\Table
 */
class ProductVariable implements IVariable, IActiveVariable
{
    ...
    public function __construct(ItemContext $context, array $config, Core $view, Formatter $formatter)
    {
        ...
        if (!empty($this->product['delivery_date'])) {
            $this->delivery_date = fn_date_format($this->product['delivery_date']);
        }
    ...
    public static function attributes()
    {
        return [
            ...
            'is_edp', 'edp_shipping', 'stored_price', 'counter', 'main_pair', 'image', 'options', 'delivery_date',
            'raw' => [
